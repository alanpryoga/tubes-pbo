...
public class LaporanPenjualan {
    ...
    private final String[] arrBulan = {"Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"};
    
    public void tampilMenu(Koneksi conn, User user) throws FileNotFoundException, DocumentException, ParseException {
        int bulan, tahun;
        Scanner scan = new Scanner(System.in);
        
        System.out.print("Masukkan bulan [1, 2, 3,..., 12]: ");
        bulan = scan.nextInt();
        ...
        try {
            ...
            String documentLocation = "/Downloads/LaporanPenjualan-" + arrBulan[bulan - 1] + "-" + tahun + ".pdf";
            
            PdfWriter.getInstance(document, new FileOutputStream(System.getProperty("user.home") + documentLocation));

            document.open();
            
            Paragraph title = new Paragraph("Laporan Penjualan Bulan " + arrBulan[bulan - 1] + " Tahun " + tahun);
